...
+--------------+----------------+----------------+-----------------------+---------------------+
|WICED_SH_MB0  | WICED_GPIO_12  | D5             | Button MB0            |                     |
+--------------+----------------+----------------+-----------------------+---------------------+
|WICED_SH_MB1  | WICED_GPIO_3   | D3             | Button MB1            |                     |
+--------------+----------------+----------------+-----------------------+---------------------+
|WICED_SH_LED0 | WICED_GPIO_7   | D10            | LED0                  |                     |
+--------------+----------------+----------------+-----------------------+---------------------+
|WICED_SH_LED1 | WICED_GPIO_16  | D9             | LED1                  | WICED_PWM_4         |
+--------------+----------------+----------------+-----------------------+---------------------+
|WICED_ADC_0   | N/A            | A0             | Ambient Light Sensor  |                     |
+--------------+----------------+----------------+-----------------------+---------------------+
|WICED_ADC_1   | N/A            | A1             | DAC                   |                     |
+--------------+----------------+----------------+-----------------------+---------------------+
|WICED_ADC_2   | N/A            | A2             | POT                   |                     |
+--------------+----------------+----------------+-----------------------+---------------------+

* Note: To read the annlog signals A0-A2 using the external ADC from the BCM943907 baseboard, you must use I2C. The ADC is at device address 0x33.
...
#define WICED_SH_LED1       	( WICED_GPIO_16 )
...
#define PLATFORM_FACTORY_RESET_BUTTON_INDEX     ( PLATFORM_SH_MB1 )
