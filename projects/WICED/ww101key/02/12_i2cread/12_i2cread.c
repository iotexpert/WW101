// When the button on the base board is pressed, I2C is used to read the
// temperature (Degrees C * 100) and humidity (Percent * 10) from the
// analog co-processor on the shield board.
#include "wiced.h"
