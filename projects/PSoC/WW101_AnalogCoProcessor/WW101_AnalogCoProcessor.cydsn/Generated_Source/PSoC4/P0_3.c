...
#include "P0_3.h"
...
#if defined(P0_3__PC)
    #define P0_3_SetP4PinDriveMode(shift, mode)  \
    do { \
        P0_3_PC =   (P0_3_PC & \
                                (uint32)(~(uint32)(P0_3_DRIVE_MODE_IND_MASK << \
                                (P0_3_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << \
                                (P0_3_DRIVE_MODE_BITS * (shift))); \
    } while (0)
#else
        ...
        #define P0_3_SetP4PinDriveMode(shift, mode)  \
        do { \
            P0_3_USBIO_CTRL_REG = (P0_3_USBIO_CTRL_REG & \
                                    (uint32)(~(uint32)(P0_3_DRIVE_MODE_IND_MASK << \
                                    (P0_3_DRIVE_MODE_BITS * (shift))))) | \
                                    (uint32)((uint32)(mode) << \
                                    (P0_3_DRIVE_MODE_BITS * (shift))); \
    ...
    *******************************************************************************/
    ...
    {
		P0_3_SetP4PinDriveMode(P0_3__0__SHIFT, mode);
    }
#endif
...
{
    uint8 drVal = (uint8)(P0_3_DR & (uint8)(~P0_3_MASK));
    drVal = (drVal | ((uint8)(value << P0_3_SHIFT) & P0_3_MASK));
    P0_3_DR = (uint32)drVal;
}
...
{
    return (uint8)((P0_3_PS & P0_3_MASK) >> P0_3_SHIFT);
}
...
{
    return (uint8)((P0_3_DR & P0_3_MASK) >> P0_3_SHIFT);
}
...
void P0_3_SetInterruptMode(uint16 position, uint16 mode)
{
    ...
    intrCfg =  P0_3_INTCFG & (uint32)(~(uint32)position);
    P0_3_INTCFG = intrCfg | ((uint32)position & (uint32)mode);
}
...
{
	uint8 maskedStatus = (uint8)(P0_3_INTSTAT & P0_3_MASK);
	P0_3_INTSTAT = maskedStatus;
    return maskedStatus >> P0_3_SHIFT;
}
